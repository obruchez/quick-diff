...
* _toStrings_: returns the differences as a sequence of strings
...
The case class itself only contains one method, _toStrings_, which returns the arguments as a sequence of strings.
